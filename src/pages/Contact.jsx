...
- Project Details: ${formData.message || 'Not specified'}`;
  ...
  return (
    <section className="section section-dark" id="contact" style={{ paddingTop: '100px', paddingBottom: '30px', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
      <div className="container" style={{ maxWidth: '900px' }}>
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '12px', marginTop: '10px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.8rem', color: '#cbd5e1', background: 'rgba(255,255,255,0.05)', padding: '4px 12px', borderRadius: '100px' }}>
        ...
        <div className="contact-form-wrapper" style={{ padding: '24px', borderRadius: 'var(--border-radius-md)', background: 'rgba(17, 24, 39, 0.7)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
