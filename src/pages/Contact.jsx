...
- Project Details: ${formData.message || 'Not specified'}`;
  ...
  return (
    <section className="section section-dark" id="contact" style={{ paddingTop: '140px', paddingBottom: '80px', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
